...
```javascript
mode = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-normal-mode@v0.3.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-normal-mode/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/stats-base-dists-normal-mode/actions/workflows/test.yml?query=branch:v0.3.1
